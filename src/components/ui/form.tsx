...
const useFormField = () => {
  ...
  // Return safe default values if used outside a form context
  if (!formContext) {
    return {
      id: itemContext?.id,
...
>(({ className, ...props }, ref) => {
  // We make formDescriptionId optional here to handle cases where FormDescription
  // is used outside of a proper form context
